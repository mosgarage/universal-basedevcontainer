# Universal Basedevcontainer - Windows Installer
# This script helps Windows users install the Base Devcontainer

Write-Host "Universal Basedevcontainer - Windows Installer" -ForegroundColor Cyan
...
# Install Base Devcontainer
Write-Host "Installing Universal Basedevcontainer..." -ForegroundColor Cyan

# Create .devcontainer directory if it doesn't exist
if (!(Test-Path ".devcontainer")) {
    # Download and run install script in WSL
    Write-Host "Downloading Base Devcontainer files..." -ForegroundColor Yellow
...
'@
    ...
    Write-Host "✓ Base Devcontainer installed!" -ForegroundColor Green
} else {
    Write-Host "✓ Base Devcontainer already exists" -ForegroundColor Green
}
